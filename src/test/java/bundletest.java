...
public class bundletest extends hoteltabs {
    ...
    public static Collection options() {
        return Arrays.asList(Language2.values());
    }

    public bundletest(Language2 language2) {
        this.language2 = language2;
        if (!driver.getCurrentUrl().contains("https://www.hoteltres.com/"+ language2.getLang())) {
            driver.get("https://www.hoteltres.com/"+language2.getLang());
            System.out.println(i++);
            hBundle= ResourceBundle.getBundle(language2.getLang());
    ...
    public void testTab1(){
        ...
        System.out.println("Language "+language2.getLang()+": "+hPage.tab1Test());
    ...
    public void testTab2(){
        ...
        System.out.println("Language "+language2.getLang()+": "+hPage.tab2Test());
    ...
    public void testTab3(){
        ...
        System.out.println("Language "+language2.getLang()+": "+hPage.tab3Test());
